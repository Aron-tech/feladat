<div class="pt-2 space-y-2">
    ...
    <select wire:change='selectContact($event.target.value)'>
        <option value="" disabled selected>Válassz kapcsolattartót</option>
    ...
    @foreach($contacts as $index => $contact)
        <div class="flex items-center space-x-2">
            ...
            <button type="button" wire:click="deleteContact({{ $index }}, {{ $contact['id'] ?? ''}})" class="text-red-500">Törlés</button>
        </div>
    @endforeach
